  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <IonCard>
          <img alt="Silhouette of mountains" id="cover_pic" onClick={toggleModal_coverpic} src="src/assets/img/godz.jpg" />
          <img alt="Silhouette of mountains" id="profile_pic" onClick={toggleModal_profpic} src="src/assets/img/Profile.jpg" />  

          <IonCardHeader>
            <IonCardTitle>Godffrey B. Gamaya</IonCardTitle>
            <IonCardSubtitle>3rd Year - BSIT Student</IonCardSubtitle>
          </IonCardHeader>

          <IonCardContent>Once an artist, always an artist</IonCardContent>

          <IonButton onClick={() => setShowAlert(true)} expand="block" color="light">Quick Facts</IonButton>
          ...
          <IonButton onClick={handleOpenActionSheet} expand="block" color="light">Open Action Sheet</IonButton>
          ...
          >
            <img alt="Silhouette of mountains" id="coverpic" src="src/assets/img/godz.jpg" />
          ...
          >
            ...
            <img alt="Silhouette of mountains" id="profpic" src="src/assets/img/Profile.jpg" />
